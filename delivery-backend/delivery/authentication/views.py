...
def google_login(request):
    ...
    client_id = "420742298215-p0m9b01clio90n5t3e9el83kjjqotuhq.apps.googleusercontent.com"
    
    google_url = f"https://accounts.google.com/o/oauth2/v2/auth?client_id={client_id}&response_type=code&redirect_uri={GOOGLE_CALLBACK_URI}&scope={scope}"
...
def google_callback(request):
    client_id = "420742298215-p0m9b01clio90n5t3e9el83kjjqotuhq.apps.googleusercontent.com"
    client_secret = "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"
...
def kakao_login(request):
    rest_api_key = '132e6e56a442ec9fa1decbcfadd50cfb'
    
    kakao_url = f"https://kauth.kakao.com/oauth/authorize?client_id={rest_api_key}&redirect_uri={KAKAO_CALLBACK_URI}&response_type=code"
